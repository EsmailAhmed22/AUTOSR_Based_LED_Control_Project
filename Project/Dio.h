 ...
 * error code (Not exist in AUTOSAR 4.3.1 DIO SWS Document).
 */
...
typedef struct
{
  ...
  uint8 offset;
  /* This shall be the port ID which the Channel group is defined in. */
...
{
        /* Array of structures for Channel ID */
	Dio_ConfigChannel Channels[DIO_CONFIGURED_CHANNLES];
        /* Array of structures for PORT ID */
 ...
 *                      Function Prototypes                                    *
 *******************************************************************************/
/*Function for Read Dio_ChannelGroup */
